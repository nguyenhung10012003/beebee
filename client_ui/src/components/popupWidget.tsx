    ...
    <div>
      <Disclosure>
        {({ open }) => (
          <>
            <Disclosure.Button
              className="fixed z-40 flex items-center justify-center transition duration-300 bg-primary rounded-full shadow-lg right-5 bottom-5 w-14 h-14 focus:outline-none hover:bg-primary-foreground focus:bg-primaryHover ease">
            ...
            <Transition
              ...
              <Disclosure.Panel
                ...
                <div className="flex flex-col items-center justify-center h-32 p-5 bg-primaryHover">
                  ...
                  {!isSubmitSuccessful && (
                    <form onSubmit={handleSubmit(onSubmit)} noValidate>
                        ...
                        <input
                          ...
                          className={`w-full px-3 py-2 text-gray-600 placeholder-gray-300 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring   ${
                            errors.name
                              ...
                              : 'border-gray-300 focus:border-primaryHover ring-indigo-100'
                          }`}
                        />
                        {errors.name && (
                      ...
                      <div className="mb-3">
                        <button
                          type="submit"
                          className="w-full px-3 py-4 text-white bg-primary rounded-md focus:bg-primaryHover focus:outline-none">
                          {isSubmitting ? (
                            <svg
                  ...
                  {isSubmitSuccessful && isSuccess && (
                    <>
                      <div
                        ...
                        <button
                          className="mt-6 text-primaryHover focus:outline-none"
                          onClick={() => reset()}>
                          Go back
                        </button>
                      </div>
