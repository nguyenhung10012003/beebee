  ...
  return (
    <div className="relative">
      <Container>
        ...
        gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5"
        >
          <div className="lg:col-span-2">
            <div>
              {' '}
              <Link href="/"
                    className="flex items-center space-x-2 text-2xl font-medium text-textColor1">
                <Image
                  src="/logo.svg"
                  alt="N"
                  width="32"
            ...
            <div className="flex flex-wrap w-full -mt-2 -ml-3 lg:ml-0">
              {navigation.map((item: any, index: number) => (
                <Link key={index} href={item.href}
                      className="w-full px-4 py-2 text-gray-500 rounded-md dark:text-gray-300 hover:text-textColor1 focus:text-indigo-500 focus:bg-indigo-100 focus:outline-none dark:focus:bg-trueGray-700">
                  {item.title}
                </Link>
              ))}
            </div>
          ...
          <div className="">
            <div>Follow us</div>
            <div className="flex mt-5 space-x-5 text-textColor1">
              <a
                href=""
                target="_blank"
                rel="noopener">
        ...
        <div className="my-10 text-sm text-center text-gray-600 dark:text-gray-400">
          Copyright © {new Date().getFullYear()}. Template by{' '}
          <a
...
const Twitter: FC<{ size?: number }> = ({ size = 24 }) => (
  <svg
...
const Facebook: FC<{ size?: number }> = ({ size = 24 }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
const Instagram: FC<{ size?: number }> = ({ size = 24 }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
const Linkedin: FC<{ size?: number }> = ({ size = 24 }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
